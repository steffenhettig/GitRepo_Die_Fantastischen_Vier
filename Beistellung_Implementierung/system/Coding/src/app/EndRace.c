...
/**
 * Implementation of the EndRace_Process method
 */
static Events EndRace_Process(void) 
{
...
// Create and initialize EndRace_Handler instance
EndRace_Handler EndRace_Handler_instance = {
    .EndRace_Process = EndRace_Process
};
